package io.apps.repository;

import io.apps.SampleApp;
import io.apps.config.Constants;
import io.apps.config.audit.AuditEventConverter;
import io.apps.domain.PersistentAuditEvent;
...
import static io.apps.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
