package io.apps.web.rest;

import io.apps.config.Constants;
import io.apps.SampleApp;
import io.apps.domain.Authority;
import io.apps.domain.User;
import io.apps.repository.AuthorityRepository;
import io.apps.repository.UserRepository;
import io.apps.security.AuthoritiesConstants;
import io.apps.service.MailService;
import io.apps.service.dto.UserDTO;
import io.apps.web.rest.errors.ExceptionTranslator;
import io.apps.web.rest.vm.KeyAndPasswordVM;
import io.apps.web.rest.vm.ManagedUserVM;
import io.apps.service.UserService;
